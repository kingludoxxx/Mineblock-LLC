...
const CKT_TEMPLATE_JS = `(function(){
  ...
  function billingSame(){var cb=document.querySelector('.ckt-billing .ckt-check');return !cb||cb.checked;}
  function customerPayload(){
    var shipping={address1:fv('address1'), address2:fv('address2'), city:fv('city'),
                  state:fv('state'), zip:fv('postal'), country:fv('country')};
    var out={customer:{email:fv('email'), phone:fv('phone'),
      first_name:fv('first_name'), last_name:fv('last_name'), shipping:shipping}};
    /* Only send a distinct billing block when the buyer unticks "same as
       shipping". The billing fields lack state/country, so inherit those from
       shipping — a billing address without a country is not a valid address. */
    if(!billingSame()){
      out.customer.billing={
        first_name:fv('billing_first_name')||fv('first_name'),
        last_name:fv('billing_last_name')||fv('last_name'),
        address1:fv('billing_address1'), city:fv('billing_city'),
        zip:fv('billing_postal'), state:shipping.state, country:shipping.country};
    }
    return out;}
  ...
  ['email','phone','first_name','last_name','address1','address2','city','state','postal','country','billing_first_name','billing_last_name','billing_address1','billing_city','billing_postal']
  ...
  var bcb=document.querySelector('.ckt-billing .ckt-check');if(bcb){bcb.addEventListener('change',scheduleSync);}
...
export function checkoutPageTemplate() {
  ...
  const blocks = [
    ...
    html('ckt_footer', 'checkout-footer-links',
      `<footer class='ckt-footer'><a href='https://trypuure.co/policies/refund-policy' target='_blank' rel='noopener'>Return policy</a><a href='https://trypuure.co/policies/privacy-policy' target='_blank' rel='noopener'>Privacy policy</a><a href='https://trypuure.co/policies/terms-of-service' target='_blank' rel='noopener'>Terms of service</a></footer>`),
    html('ckt_summary', 'checkout-order-summary',
      `<aside class='ckt-summary'><div class='ckt-summary-inner'>` +
      `<div class='ckt-summary-top'><a class='ckt-continue' href='https://trypuure.co' target='_blank' rel='noopener'><svg width='16' height='16' viewBox='0 0 24 24' fill='none' stroke='currentColor' stroke-width='2' aria-hidden='true'><circle cx='9' cy='21' r='1'/><circle cx='20' cy='21' r='1'/><path d='M1 1h4l2.68 13.39a2 2 0 0 0 2 1.61h9.72a2 2 0 0 0 2-1.61L23 6H6'/></svg> Continue shopping</a></div>` +

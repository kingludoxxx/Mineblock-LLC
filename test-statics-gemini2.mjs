#!/usr/bin/env node
// Gemini 3.1 Extended Test — 7 more references for comprehensive comparison
...
async function main() {
  console.log('=== GEMINI 3.1 EXTENDED TEST (Batch 2) ===');
  ...
  const tests = [
    // Mars hero — was 6/10 with NanoBanana
    { ref: 'https://xn7q-nefz-qhlj.n7d.xano.io/vault/r4fM_Vz3/qjSNJhugKkGnlYCejvPjfP46s4A/ejc7Cg../4361.webp', angle: 'Curiosity', label: 'gemini2-mars-4361' },
    // New references not tested before
    { ref: 'https://xn7q-nefz-qhlj.n7d.xano.io/vault/r4fM_Vz3/qoP-YXSUZLxCurLVpS5ahLhtpNE/1yGPUw../3865.webp', angle: 'Urgency/Scarcity', label: 'gemini2-urgency-3865' },
    { ref: 'https://xn7q-nefz-qhlj.n7d.xano.io/vault/r4fM_Vz3/L4cq86xshRbGgYU8YzxLF0OMCDw/5vXbYg../4114.webp', angle: 'Social Proof', label: 'gemini2-social-4114' },
    { ref: 'https://xn7q-nefz-qhlj.n7d.xano.io/vault/r4fM_Vz3/P09NVTnl4TjBm-2QLM0bwG1QIFI/dBu1VA../3297.webp', angle: 'Value Proposition', label: 'gemini2-value-3297' },
    { ref: 'https://xn7q-nefz-qhlj.n7d.xano.io/vault/r4fM_Vz3/sDJEP09JkQE1a1u0jDlVhwuGqQ0/fvN8uA../4633.webp', angle: null, label: 'gemini2-promo-4633' },
    // Re-test stack and comparison for consistency
    { ref: 'https://xn7q-nefz-qhlj.n7d.xano.io/vault/r4fM_Vz3/5GJqQNh56CWQYjGpdotizxTqhug/0pgzUg../4545.webp', angle: 'Social Proof', label: 'gemini2-stack-4545-v2' },
    { ref: 'https://xn7q-nefz-qhlj.n7d.xano.io/vault/r4fM_Vz3/DJ6lbSosi847hcS_hWlxrdUXEDA/RCSP2Q../3732.webp', angle: null, label: 'gemini2-compare-3732-v2' },
  ];

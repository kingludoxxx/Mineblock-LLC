#!/usr/bin/env node
// Batch 6: Test dynamic swap limit — complex layouts should now keep all swaps
...
async function main() {
  console.log('=== Batch 6: Dynamic Swap Limit Test ===\n');
  ...
  const tests = [
    // The worst performer — comparison layout (was 3/10)
    { ref: 'https://xn7q-nefz-qhlj.n7d.xano.io/vault/r4fM_Vz3/DJ6lbSosi847hcS_hWlxrdUXEDA/RCSP2Q../3732.webp', angle: null, label: 'v5-compare-3732' },
    // Mars layout — was 4/10 in B4, 6/10 in B5
    { ref: 'https://xn7q-nefz-qhlj.n7d.xano.io/vault/r4fM_Vz3/qjSNJhugKkGnlYCejvPjfP46s4A/ejc7Cg../4361.webp', angle: 'Curiosity', label: 'v5-curiosity-4361' },
    // Notes layout — was 7/10 (good but truncation issues)
    { ref: 'https://xn7q-nefz-qhlj.n7d.xano.io/vault/r4fM_Vz3/3ADJaAVyHseGn0cKPzimGrRfRAY/DDWUqw../4408.webp', angle: 'Value Proposition', label: 'v5-value-4408' },
  ];

...
export default function ScriptGeneratorPanel({
  ...
  return (
    <div className="space-y-8">
      {/* Reference banner — shown when this panel was opened from a League Reference card */}
      {referenceLabel && (
        <div className="flex items-center justify-between gap-2 px-3 py-2 rounded-lg border border-violet-500/25 bg-violet-500/5">
          <div className="flex items-center gap-2 min-w-0">
            <Trophy className="w-3.5 h-3.5 text-violet-400 shrink-0" />
            <div className="min-w-0">
              <div className="text-[10px] font-mono uppercase tracking-[0.15em] text-violet-400/80">
                Imported from League
              </div>
              <div className="text-xs text-violet-200 font-medium truncate">{referenceLabel}</div>
            </div>
          </div>
          {onClearReference && (
            <button
              ...
              className="p-1 rounded text-violet-300/60 hover:text-violet-200 hover:bg-white/[0.04] transition-colors cursor-pointer"

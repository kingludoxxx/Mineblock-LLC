      ...
      <div style={styles.page}>
        <div style={styles.accessDenied}>
          ...
          <p style={{ color: '#666', fontSize: 14 }}>
            Invalid or expired token. Please contact {brand.shortName} for a valid link.
          </p>
        </div>
      </div>
    );
    ...
    <div style={styles.page}>
      <div style={styles.container}>
          ...
          <div style={styles.headerTop}>
            <div>
              <div style={styles.logo}>
                {/* W8a: a store with no BRAND_LOGO_BLACK prints its own name, not another store's image. */}
                {brand.logoBlack
                  ? <img src={brand.logoBlack} alt={brand.shortName} style={{ height: 23, width: 'auto' }} />
                  : <span style={{ fontSize: 17, fontWeight: 700, letterSpacing: '-0.01em' }}>{brand.shortName}</span>}
              </div>
        ...
        <footer style={styles.footer}>
          Generated by {brand.shortName} KPI System &middot; {new Date().toLocaleString()}
        </footer>
      </div>

...
import { BRAND_SHORT_NAME, BRAND_LOGO_BLACK } from '../../config/brand';
      ...
      <div style={styles.page}>
        <div style={styles.accessDenied}>
          ...
          <p style={{ color: '#666', fontSize: 14 }}>
            Invalid or expired token. Please contact {BRAND_SHORT_NAME} for a valid link.
          </p>
        </div>
      </div>
    );
    ...
    <div style={styles.page}>
      <div style={styles.container}>
          ...
          <div style={styles.headerTop}>
            <div>
              <div style={styles.logo}>
                <img src={BRAND_LOGO_BLACK} alt={BRAND_SHORT_NAME} style={{ height: 23, width: 'auto' }} />
              </div>
        ...
        <footer style={styles.footer}>
          Generated by {BRAND_SHORT_NAME} KPI System &middot; {new Date().toLocaleString()}
        </footer>
      </div>
